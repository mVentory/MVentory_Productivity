 ...
 *
 * @category ZetaPrints_Productivity_Block_Widget_Attribute
 * @package  ZetaPrints_Productivity
 * @author ZetaPrints
 */

class ZetaPrints_Productivity_Model_Widget_Attribute {
   ...
   * @param string $code
   *
   * @return ZetaPrints_Productivity_Model_Widget_Attribute
   */
